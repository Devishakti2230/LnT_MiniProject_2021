...
* Calculator application with several modes of operations
*
*/
#ifndef __CALCULATOR_MODES_OF_FUNCTIONS_H__
#define __CALCULATOR_MODES_OF_FUNCTIONS_H__
 ...
 * 
 */
typedef struct simple_interest_operations
{
...
#endif  /* #define __CALCULATOR_FUNCTIONS_H__ */
